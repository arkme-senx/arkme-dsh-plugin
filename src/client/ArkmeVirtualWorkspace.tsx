...
const styles: Record<string, CSSProperties> = {
  ...
  sortMenu: {
    position: 'absolute', zIndex: 30, top: 32, right: -20, width: 96, padding: 4,
  ...
  sortMenuItem: {
    position: 'relative', width: '100%', height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center',
    padding: '0 24px', border: 0, borderRadius: 7, background: 'transparent', color: 'inherit',
    textAlign: 'center', cursor: 'pointer', font: 'inherit', fontSize: 13, lineHeight: '20px',
  },
  sortMenuItemLabel: { minWidth: 0 },
  sortMenuCheck: { position: 'absolute', right: 7, width: 14, height: 14, color: colors.secondary },
