...
const styles: Record<string, CSSProperties> = {
  ...
  body: { flex: 1, minWidth: 0, minHeight: 0, overflowY: 'auto', overscrollBehavior: 'contain', background: '#fff' },
  ...
  feed: { width: 'min(780px, calc(100% - 64px))', margin: '6px auto 48px', display: 'grid', gap: 0 },
  card: { padding: '18px 4px 16px', border: 0, borderBottom: `1px solid ${colors.border}`, borderRadius: 0, background: '#fff' },
  cardHeader: { display: 'grid', gridTemplateColumns: '36px minmax(0,1fr) auto', alignItems: 'center', gap: 10 },
  ...
  time: { color: '#989ba3', fontSize: 10 },
  headline: { margin: '12px 0 0', fontSize: 15, lineHeight: 1.5, fontWeight: 600 },
  text: { margin: '8px 0 0', whiteSpace: 'pre-wrap', wordBreak: 'break-word', color: '#3b3f48', fontSize: 13, lineHeight: 1.62 },
  imageGrid: { maxWidth: 620, marginTop: 12, display: 'grid', gridTemplateColumns: 'repeat(3,minmax(0,1fr))', gap: 6 },
