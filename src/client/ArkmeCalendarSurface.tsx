  ...
  return <article style={styles.recordRow}>
    <div style={styles.recordStack}>
      ...
      <div style={styles.recordBubble}>
        ...
        {sourceLabel === '' ? null : <span
          data-arkme-calendar-source="dsh_agent_input"
