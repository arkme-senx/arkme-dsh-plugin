...
export const arkmeTheme = {
  ...
  messageOwn: 'var(--arkme-chat-self-bubble, var(--dsw-specific-bubble, #effaf0))',
  ...
  accent: 'var(--dsw-alias-state-success-primary, #09b83e)',
  accentSoft: 'var(--dsw-alias-state-success-tertiary, #def3e8)',
