...
interface DesktopCallFrameWindow extends Window {
  __JOTMO_DESKTOP_CALL_HOST__?: { onHostMessage?: (message: string) => void }
}
...
export function sendDesktopCallCommand(
  ...
  const host = (frame.contentWindow as DesktopCallFrameWindow | null)?.__JOTMO_DESKTOP_CALL_HOST__
