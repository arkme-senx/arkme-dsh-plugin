...
const BUSINESS_PROMPT_SUFFIX =
  ...
  + ' For owned OpenClaw Bots, use arkme_bots_list to obtain account-bound bot_ref values. Use arkme_bot_create only after an '
  + 'explicit human request in the current conversation. Never automatically retry Bot creation when its outcome is unknown; '
