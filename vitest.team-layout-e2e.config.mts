...
export default { ...harnessConfig, test: { ...harnessConfig.test, include: [resolve(import.meta.dirname, 'tests/e2e/team-layout.e2e.mjs')], fileParallelism: false, testTimeout: 180_000 } }
