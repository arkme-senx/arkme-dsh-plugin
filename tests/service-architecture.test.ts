...
const expectedPublicMethods = [
  ...
  'sendSourceRich', 'favoriteStickers', 'saveFavoriteStickers', 'manageFavoriteSticker', 'sendFavoriteSticker', 'longArticleDetail', 'updateLongArticle', 'getLongArticleDraft',
