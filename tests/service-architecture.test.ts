...
const expectedServiceFiles = [
  ...
  'service.ts', 'auth-service.ts', 'profile-service.ts', 'bot-service.ts', 'bot-conversation-service.ts', 'social-access-service.ts', 'source-service.ts',
