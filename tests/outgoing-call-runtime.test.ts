...
import type { JotmoOutgoingCallIntentClaim, JotmoOutgoingCallPrepareResult } from '../src/outgoing-call-contract.js'
...
const prepareResult: JotmoOutgoingCallPrepareResult = {
...
describe('outgoing call runtime', () => {
  ...
  it('claims Tool intents and resolves success only after the iframe reports calling', async () => {
    const claim: JotmoOutgoingCallIntentClaim = {
