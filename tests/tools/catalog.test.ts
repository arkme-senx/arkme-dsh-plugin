...
describe('Arkme tool catalog', () => {
  ...
  it('separates registration phase from business kind and write policy', () => {
    ...
    expect(writes.map(module => module.meta.toolName)).toEqual([
      ...
      'arkme_world_voiceprint_invite', 'arkme_world_publish_text', 'arkme_extension_review_create', 'arkme_group_member_add', 'arkme_message_report', 'arkme_group_ai_polish_manage',
