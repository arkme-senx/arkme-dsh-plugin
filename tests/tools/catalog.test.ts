...
describe('Arkme tool catalog', () => {
  ...
  it('separates registration phase from business kind and write policy', () => {
    ...
    expect(writes.map(module => module.meta.toolName)).toEqual([
      ...
      'arkme_world_publish_text', 'arkme_extension_review_create', 'arkme_group_member_add', 'arkme_group_member_remove', 'arkme_group_join_restriction_set', 'arkme_copy_link_extend', 'arkme_conversation_mark_read', 'arkme_message_report', 'arkme_message_withdraw', 'arkme_user_ban', 'arkme_user_unban', 'arkme_group_ai_polish_manage',
