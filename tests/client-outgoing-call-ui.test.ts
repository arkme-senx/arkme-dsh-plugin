...
import { JotmoPrivateCallMenu } from '../src/client/JotmoPrivateCallMenu.js'
import { outgoingCallModalLayout } from '../src/client/JotmoOutgoingCallHost.js'

describe('outgoing call UI', () => {
  it('renders the exact-size private-chat call trigger with the pinned frontend icon', () => {
    const html = renderToStaticMarkup(createElement(JotmoPrivateCallMenu, {
      sourceRef: 'signed-private-ref', displayName: '小林', assetBasePath: '/jotmo-self/api/call',
    }))
